...
class EventController extends Controller
{
    public function calendar(){
      ...
      ///////////////////////////////
      //今日の情報を作成
      //ココはcalendarChange()と違う（今日）
      $currentDate = CarbonImmutable::today()->format('m月d日');   


      ///////////////////////////////
      //今週の情報を$currentWeek として作成
      $currentWeek = [];

      //ココはchangeと違う（こっちは今日が基準）
      for($i = 0; $i < 7; $i++):
      ...
      //ココはcalendarChange()と違う（本日が基準なので） 
    ...
    public function show(Event $event){
        ...
        //   ];
        //   array_push($reservations, $reservation); // 連想配列に追加
        // }
        ...
        // return view('events.show',compact('event','users','reservations','eventDate','startTime','endTime','reservablePeople','ownReserveExists'));
